...
public class main {
    ...
    String isMutant = "false";
    int preguntas = 3;

    public static void main(String args[]) {

        RqIsMutantDto rqIsMutantDto = new RqIsMutantDto();

        rqIsMutantDto.setArgs(new String[]{"ATTTCA",
                "ATTTCA",
                "ATTTCA",
                "ATTTCA",
                "CCCCAA",
                "TCACCG"});
        //rqIsMutantDto.setArgs(new String[]{"TTTTTT", "CAGTGC", "TTATGT", "AGAAGG", "CCCCTA", "TCACTG"});
        main main = new main();
        System.out.println(main.process(rqIsMutantDto));
    }


    public String process(RqIsMutantDto args) {
        //Gson gson = new GsonBuilder().setPrettyPrinting().create();
        //RqIsMutantDto args = gson.fromJson(input.toString(), RqIsMutantDto.class);
        String[] dna = args.getArgs();
